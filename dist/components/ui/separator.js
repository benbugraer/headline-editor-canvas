...
var Separator = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(SeparatorPrimitive.Root, __assign({ ref: ref, decorative: decorative, orientation: orientation, className: (0, utils_1.cn)("shrink-0 bg-neutral-200 dark:bg-neutral-800", orientation === "horizontal" ? "h-[1px] w-full" : "h-full w-[1px]", className) }, props)));
});
