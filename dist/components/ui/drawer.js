...
var DrawerOverlay = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(vaul_1.Drawer.Overlay, __assign({ ref: ref, className: (0, utils_1.cn)("fixed inset-0 z-50", className) }, props)));
});
...
var DrawerContent = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(DrawerPortal, null,
        ...
        React.createElement(vaul_1.Drawer.Content, __assign({ ref: ref, className: (0, utils_1.cn)("fixed left-[6.97rem] top-[7.2rem] z-50 h-full w-[300px] flex flex-col border rounded-r-md bg-secondary", className) }, props),
            React.createElement("div", { className: "mx-auto mt-4 rotate-90 rounded-full" }),
            children)));
});
...
var DrawerHeader = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ className: (0, utils_1.cn)("grid gap-1.5 p-3 text-center sm:text-left", className) }, props)));
};
