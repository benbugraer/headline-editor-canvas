...
var TextFormattingControls = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "flex items-center space-x-2" },
        ...
        alignButtons.map(function (_a) {
            ...
            return (react_1.default.createElement(button_1.Button, { key: id, id: "".concat(id, "-mode"), variant: "ghost", size: "icon", className: (0, clsx_1.default)("bg-transparent hover:bg-none", textFormatting.textAlign === align && "bg-tertiary"), onClick: function () {
