...
export declare const ShapeRadiusControl: React.MemoExoticComponent<({ radius, onChange, isCircle }: ShapeRadiusControlProps) => import("react/jsx-runtime").JSX.Element>;
export {};
