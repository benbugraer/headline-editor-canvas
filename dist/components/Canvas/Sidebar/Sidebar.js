...
function Sidebar(_a) {
    ...
    var renderSidebarItem = function (item) {
        switch (item.label) {
            case "İkon Ekle":
                return ((0, jsx_runtime_1.jsx)(IconDrawer_1.IconDrawer, { isOpen: isIconDrawerOpen, onOpenChange: setIsIconDrawerOpen, onIconSelect: function (icon) { return handleAddIcon(icon, "defaultColor"); }, item: item }));
            case "Manşet Seç":
                return ((0, jsx_runtime_1.jsx)(HeadlineDrawer_1.HeadlineDrawer, { isOpen: isHeadlineDrawerOpen, onOpenChange: setIsHeadlineDrawerOpen, canvas: canvas, item: item }));
            default:
                return ((0, jsx_runtime_1.jsx)(SidebarButton_1.SidebarButton, { icon: item.icon, label: item.label, onClick: itemHandlers[item.label] }));
        }
    };
    return ((0, jsx_runtime_1.jsx)("div", { className: "w-28 flex flex-col border-r bg-gray-50 shadow-lg", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex-1 overflow-y-auto p-4", children: [(0, jsx_runtime_1.jsx)("input", { type: "file", ref: fileInputRef, className: "hidden", onChange: handleFileChange, accept: "image/*" }), (0, jsx_runtime_1.jsx)("nav", { className: "space-y-2", children: canvas_types_1.SIDEBAR_ITEMS.map(function (item) { return ((0, jsx_runtime_1.jsx)("div", { children: renderSidebarItem(item) }, item.label)); }) })] }) }));
}
